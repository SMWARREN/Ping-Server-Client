...
//It talks to  the  client
// Sean Warren - Talk Server 3/1/2014

import java.io.*;
import java.net.*;// sets up the necessary packages needed
...
public class TalkClient
{
	public static void main(String[] args)
	{
	  ...
	  // String host = "HRTMATH2619.campus.bridgew.edu";//my machine in office
          ...
          while (true)
    	  {
    		  if((s = reader.readLine()) != null)  // get input from the KBD
    		  {
    			  ...
    			  if (s.equalsIgnoreCase("END"))
                              {
                               //send END message to server to close down.
                                out.println("END");
                                //respond to KBD.
